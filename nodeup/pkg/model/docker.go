...
var dockerVersions = []dockerVersion{
	// 1.11.2 - Jessie
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.11.2-0~jessie_amd64.deb"},
	...
	// 1.11.2 - Xenial
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.11.2-0~xenial_amd64.deb"},
	...
	// 1.11.2 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.11.2",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-1.11.2-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.11.2",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-selinux-1.11.2-1.el7.centos.noarch.rpm"},
	...
	// 1.12.1 - Jessie
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.1-0~jessie_amd64.deb"},
	...
	// 1.12.1 - Xenial
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.1-0~xenial_amd64.deb"},
	...
	// 1.12.1 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.1",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-1.12.1-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.1",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-selinux-1.12.1-1.el7.centos.noarch.rpm"},
	...
	// 1.12.3 - Jessie
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.3-0~jessie_amd64.deb"},
	...
	// 1.12.3 - Jessie on ARM
	{
		...
		Version:       "1.12.3-0~jessie",
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.3-0~jessie_armhf.deb"},
	...
	// 1.12.3 - Xenial
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.3-0~xenial_amd64.deb"},
	...
	// 1.12.3 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.3",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-1.12.3-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.3",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-selinux-1.12.3-1.el7.centos.noarch.rpm"},
	...
	// 1.12.6 - Jessie
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.6-0~debian-jessie_amd64.deb"},
	...
	// 1.12.6 - Debian9 (stretch)
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.6-0~debian-stretch_amd64.deb"},
	...
	// 1.12.6 - Jessie on ARM
	{
		...
		Architectures: []Architecture{ArchitectureArm},
		Version:       "1.12.6-0~debian-jessie",
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.6-0~debian-jessie_armhf.deb"},
	...
	// 1.12.6 - Xenial
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.6-0~ubuntu-xenial_amd64.deb"},
	...
	// 1.12.6 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.6",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-1.12.6-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.12.6",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-selinux-1.12.6-1.el7.centos.noarch.rpm"},
	...
	// 1.13.1 - Debian9 (stretch)
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.13.1-0~debian-stretch_amd64.deb"},
	...
	// 1.13.1 - Jessie
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.13.1-0~debian-jessie_amd64.deb"},
	...
	// 1.13.1 - Jessie on ARM
	{
		...
		Architectures: []Architecture{ArchitectureArm},
		Version:       "1.13.1-0~debian-jessie",
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.13.1-0~debian-jessie_armhf.deb"},
	...
	// 1.13.1 - Xenial
	{
		...
		Source:        []string{"http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.13.1-0~ubuntu-xenial_amd64.deb"},
	...
	// 1.13.1 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.13.1",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-1.13.1-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "1.13.1",
		Source:        []string{"https://yum.dockerproject.org/repo/main/centos/7/Packages/docker-engine-selinux-1.13.1-1.el7.centos.noarch.rpm"},
	...
	// 17.03.2 - Debian9 (stretch)
	{
		...
		Source:        []string{"http://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/docker-ce_17.03.2~ce-0~debian-stretch_amd64.deb"},
	...
	// 17.03.2 - Jessie
	{
		...
		Source:        []string{"http://download.docker.com/linux/debian/dists/jessie/pool/stable/amd64/docker-ce_17.03.2~ce-0~debian-jessie_amd64.deb"},
	...
	// 17.03.2 - Jessie on ARM
	{
		...
		Architectures: []Architecture{ArchitectureArm},
		Version:       "17.03.2~ce-0~debian-jessie",
		Source:        []string{"http://download.docker.com/linux/debian/dists/jessie/pool/stable/armhf/docker-ce_17.03.2~ce-0~debian-jessie_armhf.deb"},
	...
	// 17.03.2 - Xenial
	{
		...
		Source:        []string{"http://download.docker.com/linux/ubuntu/dists/xenial/pool/stable/amd64/docker-ce_17.03.2~ce-0~ubuntu-xenial_amd64.deb"},
	...
	// 17.03.2 - Ubuntu Bionic via binary download (no packages available)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Source:        []string{"http://download.docker.com/linux/static/stable/x86_64/docker-17.03.2-ce.tgz"},
	...
	// 17.03.2 - Centos / Rhel7 (two packages)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "17.03.2.ce",
		Source:        []string{"https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-17.03.2.ce-1.el7.centos.x86_64.rpm"},
	...
	},
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "17.03.2.ce",
		Source:        []string{"https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-selinux-17.03.2.ce-1.el7.centos.noarch.rpm"},
	...
	// 17.09.0 - Jessie
	{
		...
		Source:        []string{"http://download.docker.com/linux/debian/dists/jessie/pool/stable/amd64/docker-ce_17.09.0~ce-0~debian_amd64.deb"},
	...
	// 17.09.0 - Jessie on ARM
	{
		...
		Architectures: []Architecture{ArchitectureArm},
		Version:       "17.09.0~ce-0~debian",
		Source:        []string{"http://download.docker.com/linux/debian/dists/jessie/pool/stable/armhf/docker-ce_17.09.0~ce-0~debian_armhf.deb"},
	...
	// 17.09.0 - Debian9 (stretch)
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "17.09.0~ce-0~debian",
		Source:        []string{"http://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/docker-ce_17.09.0~ce-0~debian_amd64.deb"},
	...
	// 17.09.0 - Xenial
	{
		...
		Source:        []string{"http://download.docker.com/linux/ubuntu/dists/xenial/pool/stable/amd64/docker-ce_17.09.0~ce-0~ubuntu_amd64.deb"},
	...
	// 17.09.0 - Centos / Rhel7
	{
		...
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "17.09.0.ce",
		Source:        []string{"https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-17.09.0.ce-1.el7.centos.x86_64.rpm"},
	...
	// 18.03.1 - Bionic
	{
		...
		Source:        []string{"https://download.docker.com/linux/ubuntu/dists/bionic/pool/stable/amd64/docker-ce_18.03.1~ce~3-0~ubuntu_amd64.deb"},
	...
	// 18.06.1 - Debian Stretch
	{
		...
		Source:        []string{"https://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/docker-ce_18.06.1~ce~3-0~debian_amd64.deb"},
		Hash:          "18473b80e61b6d4eb8b52d87313abd71261287e5",
		Dependencies:  []string{"bridge-utils", "libapparmor1", "libltdl7", "perl"},
	},

	// 18.06.1 - Debian Jessie
	{
		DockerVersion: "18.06.1",
		Name:          "docker-ce",
		Distros:       []distros.Distribution{distros.DistributionDebian9},
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "18.06.1~ce-0~debian",
		Source:        []string{"https://download.docker.com/linux/debian/dists/jessie/pool/stable/amd64/docker-ce_18.06.1~ce~3-0~debian_amd64.deb"},
		Hash:          "2937175fe59ee0b0843442535d2c228ada5e027a",
		Dependencies:  []string{"bridge-utils", "libapparmor1", "libltdl7", "perl"},
	},
	...
	// 18.06.1 - Xenial
	{
		...
		Distros:       []distros.Distribution{distros.DistributionXenial},
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "18.06.1~ce-0~ubuntu",
		Source:        []string{"https://download.docker.com/linux/ubuntu/dists/xenial/pool/stable/amd64/docker-ce_18.06.1~ce~3-0~ubuntu_amd64.deb"},
		Hash:          "cb0708d2b4de4d5603663cbef77cf50c9d8f1a46",
		Dependencies:  []string{"bridge-utils", "iptables", "libapparmor1", "libltdl7", "perl"},
		//Depends: iptables, init-system-helpers, lsb-base, libapparmor1, libc6, libdevmapper1.02.1, libltdl7, libeseccomp2, libsystemd0
		//Recommends: aufs-tools, ca-certificates, cgroupfs-mount | cgroup-lite, git, xz-utils, apparmor
	},
	...
	// 18.06.1 - Bionic
	{
		...
		Source:        []string{"https://download.docker.com/linux/ubuntu/dists/bionic/pool/stable/amd64/docker-ce_18.06.1~ce~3-0~ubuntu_amd64.deb"},
		Hash:          "6e35ad1137602d90cbaf4c44b35545ecf7221905",
		Dependencies:  []string{"bridge-utils", "iptables", "libapparmor1", "libltdl7", "perl"},
	},

	// 18.09.0 - Debian Stretch
	{
		DockerVersion: "18.09.0",
		Name:          "docker-ce",
		Distros:       []distros.Distribution{distros.DistributionDebian9},
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "18.09.0~ce-0~debian",
		Source: []string{"https://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/containerd.io_1.2.0-1_amd64.deb",
			"https://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/docker-ce-cli_18.09.0~3-0~debian-stretch_amd64.deb",
			"https://download.docker.com/linux/debian/dists/stretch/pool/stable/amd64/docker-ce_18.09.0~3-0~debian-stretch_amd64.deb"},
		Hash:         "294b5e4756e8cae68a9a9b51e904fca305473732",
		Dependencies: []string{"bridge-utils", "libapparmor1", "libltdl7", "perl"},
	},
	...
	// 18.09.0 - Bionic
	{
		...
		Distros:       []distros.Distribution{distros.DistributionBionic},
		Architectures: []Architecture{ArchitectureAmd64},
		Version:       "18.09.0~ce~3-0~ubuntu",
		Source: []string{"https://download.docker.com/linux/ubuntu/dists/bionic/pool/stable/amd64/containerd.io_1.2.0-1_amd64.deb",
			"https://download.docker.com/linux/ubuntu/dists/bionic/pool/stable/amd64/docker-ce-cli_18.09.0~3-0~ubuntu-bionic_amd64.deb",
			"https://download.docker.com/linux/ubuntu/dists/bionic/pool/stable/amd64/docker-ce_18.09.0~3-0~ubuntu-bionic_amd64.deb"},
		Hash:         "977e73e632ef6093699c3a17c2a1109ada7bb162",
		Dependencies: []string{"bridge-utils", "iptables", "libapparmor1", "libltdl7", "perl"},
		//Depends: iptables, init-system-helpers, lsb-base, libapparmor1, libc6, libdevmapper1.02.1, libltdl7, libeseccomp2, libsystemd0
		//Recommends: aufs-tools, ca-certificates, cgroupfs-mount | cgroup-lite, git, xz-utils, apparmor
	},
...
func (b *DockerBuilder) Build(c *fi.ModelBuilderContext) error {
	...
	// Add packages
	{
		...
		for i := range dockerVersions {
			...
			if dv.PlainBinary {
				for arch := range dv.Source {
					c.AddTask(&nodetasks.Archive{
						Name:            "docker",
						Source:          dv.Source[arch],
						Hash:            dv.Hash,
						TargetDir:       "/usr/bin/",
						StripComponents: 1,
					})
				...
				for pkg := range dv.Source {
					c.AddTask(&nodetasks.Package{
						Name:    dv.Name + string(pkg),
						Version: s(dv.Version),
						Source:  s(dv.Source[pkg]),
						Hash:    s(dv.Hash),
